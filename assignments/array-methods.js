...
console.log(`These are the runners that need to change their shirt sizes:`); console.log(runnersLargeSizeShirt);
...
console.log(`The total amount donated is ${ticketPriceTotal}`);
